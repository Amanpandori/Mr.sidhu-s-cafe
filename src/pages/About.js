           ...
           <div style={{ display: 'flex', justifyContent: 'center', padding: 30 }}>
                ...
                <ul className="list-group">
                    ...
                    <ul>
                        ...
                        <li>Form validation: Check if all mandatory fields are filled out.</li>
                        <li>Form validation: Password need to be more than 6 character and need to have alphanumeric and special characters.</li>
                    </ul>
                </ul>
                <ul className="list-group">
